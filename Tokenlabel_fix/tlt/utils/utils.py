...
def load_state_dict(checkpoint_path,model, use_ema=False, num_classes=3):
...
def load_pretrained_weights(model, checkpoint_path, use_ema=False, strict=True, num_classes=3):
