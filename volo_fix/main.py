...
parser.add_argument('--data_dir', metavar='DIR', default='./data/RiceDiseases/',
...
parser.add_argument('--ground-truth', action='store_true', default=True,
                    help='mix ground truth when use token labeling')

# Finetune ./checkpoint/d1_224_84.2.pth.tar
parser.add_argument('--finetune', default='./output/train/20210824-055026-volo_d1-224/checkpoint-109.pth.tar', type=str,                                   metavar='PATH', help='path to checkpoint file (default: none)')
